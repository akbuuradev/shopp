...
const Header = () => {
    ...
    return (
        <nav className="bg-blue-950 text-white border-gray-200 dark:bg-gray-900 top-0 sticky ">
            <div className="max-w-screen-xl text-white flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                    ...
                    <ul className="flex text-white flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-blue-950 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-blue-950 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to={"/"}
                        ...
                        <li className="relative">
                            <Link to={"/basket"}
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                Basket</Link>
                            {
                                basket.length === 0 ? null : <div className=" absolute w-6 rounded-3xl text-center bg-red-700 ml-10 top-[-15px] ">{basket.length}</div>
                            }
                        </li>
                        <li className="relative">
                            <Link to={"/favorite"}
                               className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                Favorite</Link>
                            {
                                favorite.length === 0 ? null : <div className=" absolute w-6 rounded-3xl text-center bg-red-700 ml-12 top-[-15px] ">{favorite.length}</div>
                            }
                        </li>
                    </ul>
                </div>
